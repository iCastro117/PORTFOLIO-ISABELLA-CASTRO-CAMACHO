...
const I18N = {
  en: {
    ...
    "biofog.tag": "Fog water harvesting · Universidad de La Salle",
    "biofog.sub": "Outreach Site -<br>Research Project",
    "biofog.desc": "The outreach site for BioFog Panel, a research project at Universidad de La Salle. The prototype harvests water from fog through a biodegradable panel made of bamboo and banana pseudostem, with Arduino-connected sensors measuring humidity, temperature, wind and collected volume, alongside a predictive model that estimates water efficiency.<br><br>The site presents the project to the public across seven sections: what it is, how the panel works, the process stages on video, an FAQ and the student team. Built as a single static page in plain HTML, CSS and JavaScript — no framework and no build step — with 24 hand-written inline SVG icons, 15 keyframe animations, and IntersectionObserver driving the scroll reveals.",
    ...
    "usssello.srs": "SRS",
    "brush.tag": "Agentic design-to-code auditor",
    "brush.desc": "A command-line agentic auditor that checks whether a frontend implementation actually matches its design spec. It takes the design and the shipped code, then reports every difference between them — colour drift measured in CIEDE2000, spacing and geometry, typography, and WCAG accessibility defects — grouping findings by root cause, so one broken token reads as one problem instead of twenty unrelated bugs.<br><br>Built in pure Python 3.10+ with no third-party dependencies in the core engine, running a six-stage pipeline (Extract, Map, Measure, Diagnose, Verify, Report) in which three stages are LLM agents, checked against a knowledge base of 30 UX laws and 10 usability heuristics. Every finding is deterministic and mathematically provable: across 1,500 seeded errors it reached 1.00 recall with zero false positives.",
    ...
    "nomina.tag": "with MVC Pattern",
    "nomina.heroDesc": "An application to manage employee payroll, calculating final salary based on position, benefits, and deductions.",
    "nomina.desc1": "In this project, an application was developed for employee payroll management, designed to calculate the final salary to be paid based on the position held (Employee, Officer, Manager, Operator and Technician).",
    "nomina.desc2": "The application processed key information such as base salary, days worked, overtime, bonuses, pension and health discounts, as well as transportation allowances, generating a detailed and accurate calculation of the amount to be paid for each employee.",
    "simuladorvehiculos.tag": "with MVC Pattern",
    "simuladorvehiculos.heroDesc": "An MVC-based application to simulate vehicle costs (tax, SOAT, VAT) for cars, motorcycles, and mopeds.",
    "simuladorvehiculos.desc1": "In this project, an application was developed based on the MVC (Model-View-Controller) design pattern, designed to calculate the costs associated with different types of vehicles (car, motorcycle, moped) from a base price entered by the user.",
    "simuladorvehiculos.desc2": "The application automatically processed tax, SOAT, VAT and total value calculations according to the rules defined for each type of vehicle.",
    "geoisolation.tag": "and Application in Production",
    "geoisolation.heroDesc": "A photo composition project that isolates and highlights specific landscape elements through visual design techniques.",
    "geoisolation.desc1": "By manipulating visual elements and applying design techniques, I was able to graphically highlight and isolate certain aspects of the landscape.",
    "geoisolation.desc2": "This created a visually striking composition that highlights specific elements and brings a unique perspective to the whole.",
    "burgerpackaging.tag": "Design Mockup",
    "burgerpackaging.heroDesc": "A packaging design mockup for a burger box, crafted to enhance product presentation and appeal.",
    "burgerpackaging.desc1": "When creating this burger mockup, I meticulously designed the box and packaging to enhance the presentation of the product.",
    "burgerpackaging.desc2": "Using graphic design techniques, I developed an eye-catching package that highlights the freshness and deliciousness of the burger.",
    "automata.tag": "Mechanism",
    "automata.heroDesc": "A hand-assembled automaton structure that simulates mechanical movement, combining precision, creativity, and technical instructions.",
    "automata.desc1": "The project involves the design and construction of a functional automaton structure by manually assembling parts. This process includes making cuts, folding and joining parts following detailed instructions.",
    "automata.desc2": "The objective is to create a mechanical model that simulates movement, combining basic mechanical principles with precision and creativity. This project has an educational focus, fostering skills such as patience, manual work and the interpretation of technical plans and instructions.",
    "photoretouch.tag": "Photo Retouching",
    "photoretouch.heroDesc": "A digital painting and photo retouching piece, refined through color adjustments, layers, and brush techniques.",
    "photoretouch.desc1": "Various modifications were made to this image, including hue and saturation adjustments to enhance the colours.",
    "photoretouch.desc2": "In addition, advanced techniques were used through layers and brushes, thus achieving a carefully crafted final finish.",
    "photomontage.tag": "Photo",
    "photomontage.heroDesc": "A photomontage composition blending multiple images with filters and shadows for a harmonious final result.",
    "photomontage.desc1": "This graphic composition was built from a photomontage that combines multiple images.",
    "photomontage.desc2": "Filters and strategic shadows were applied to achieve a harmonious integration between the different photographs, culminating in a final finish.",
    "ecofarm.tag": "Photo",
    "ecofarm.heroDesc": "A promotional card for an eco-tourism farm, created through photomontage blending multiple scenic images.",
    "ecofarm.desc1": "The design of this promotional card for the Eco-Tourism farm was created through a photomontage that incorporates various relevant images.",
    "ecofarm.desc2": "Filters and shadows were used to cohesively integrate the different scenes, highlighting the natural beauty and unique experiences that the farm offers.",
    "coffeemag.tagStart": "Coffee",
    "coffeemag.tagEnd": "Design",
    "coffeemag.heroDesc": "An editorial magazine celebrating Chapinero's best coffee shops, their flavors, stories, and cozy atmosphere.",
    "coffeemag.desc1": "An editorial project that celebrates the love for coffee and the spaces that surround it. This magazine is a tour of Chapinero's most beloved coffee shops, highlighting their flavors, stories, and cozy corners.",
  ...
  es: {
    ...
    "biofog.tag": "Captación de agua de niebla · Universidad de La Salle",
    "biofog.sub": "Sitio de Divulgación -<br>Proyecto de Investigación",
    "biofog.desc": "El sitio de divulgación de BioFog Panel, un proyecto de investigación de la Universidad de La Salle. El prototipo capta agua de la niebla mediante un panel biodegradable de bambú y pseudotallo de plátano, con sensores conectados a Arduino que miden humedad, temperatura, viento y volumen recolectado, junto a un modelo predictivo que estima la eficiencia hídrica.<br><br>La web presenta el proyecto al público en siete secciones: qué es, cómo funciona el panel, las etapas del proceso en video, las preguntas frecuentes y el equipo de estudiantes. Construida como una sola página estática en HTML, CSS y JavaScript puro — sin framework ni compilación — con 24 íconos SVG escritos a mano, 15 animaciones por fotogramas, y IntersectionObserver disparando las animaciones al hacer scroll.",
    ...
    "usssello.srs": "SRS",
    "brush.tag": "Auditor agéntico de diseño a código",
    "brush.desc": "Un auditor agéntico de línea de comandos que verifica si la implementación frontend coincide realmente con su especificación de diseño. Recibe el diseño y el código construido, y reporta cada diferencia entre ambos — desviación de color medida en CIEDE2000, espaciado y geometría, tipografía y defectos de accesibilidad WCAG — agrupando los hallazgos por causa raíz, de modo que un token roto se lee como un solo problema y no como veinte errores sin relación.<br><br>Construido en Python 3.10+ puro, sin dependencias de terceros en el motor central, con una tubería de seis etapas (Extraer, Mapear, Medir, Diagnosticar, Verificar, Reportar) en la que tres etapas son agentes LLM, contrastadas con una base de conocimiento de 30 leyes UX y 10 heurísticas de usabilidad. Cada hallazgo es determinístico y comprobable matemáticamente: sobre 1.500 errores sembrados alcanzó un recall de 1.00 con cero falsos positivos.",
    ...
    "nomina.tag": "con Patrón MVC",
    "nomina.heroDesc": "Una aplicación para gestionar la nómina de empleados, calculando el salario final según el cargo, las bonificaciones y los descuentos.",
    "nomina.desc1": "En este proyecto se desarrolló una aplicación para la gestión de nómina de empleados, diseñada para calcular el salario final a pagar según el cargo ocupado (Empleado, Oficial, Gerente, Operario y Técnico).",
    "nomina.desc2": "La aplicación procesaba información clave como el salario base, los días trabajados, las horas extra, las bonificaciones, los descuentos de pensión y salud, así como los auxilios de transporte, generando un cálculo detallado y preciso del monto a pagar a cada empleado.",
    "simuladorvehiculos.tag": "con Patrón MVC",
    "simuladorvehiculos.heroDesc": "Una aplicación basada en MVC para simular los costos de vehículos (impuestos, SOAT, IVA) para carros, motocicletas y motocarros.",
    "simuladorvehiculos.desc1": "En este proyecto se desarrolló una aplicación basada en el patrón de diseño MVC (Modelo-Vista-Controlador), diseñada para calcular los costos asociados a distintos tipos de vehículos (carro, motocicleta, moto) a partir de un precio base ingresado por el usuario.",
    "simuladorvehiculos.desc2": "La aplicación procesaba automáticamente los cálculos de impuestos, SOAT, IVA y valor total según las reglas definidas para cada tipo de vehículo.",
    "geoisolation.tag": "y Aplicación en Producción",
    "geoisolation.heroDesc": "Un proyecto de composición fotográfica que aísla y resalta elementos específicos del paisaje mediante técnicas de diseño visual.",
    "geoisolation.desc1": "Manipulando elementos visuales y aplicando técnicas de diseño, logré resaltar y aislar gráficamente ciertos aspectos del paisaje.",
    "geoisolation.desc2": "Esto generó una composición visualmente llamativa que resalta elementos específicos y aporta una perspectiva única al conjunto.",
    "burgerpackaging.tag": "Diseño de Mockup",
    "burgerpackaging.heroDesc": "Un mockup de diseño de empaque para una caja de hamburguesa, pensado para resaltar la presentación y el atractivo del producto.",
    "burgerpackaging.desc1": "Al crear este mockup de hamburguesa, diseñé cuidadosamente la caja y el empaque para realzar la presentación del producto.",
    "burgerpackaging.desc2": "Usando técnicas de diseño gráfico, desarrollé un empaque llamativo que resalta la frescura y lo apetitosa que se ve la hamburguesa.",
    "automata.tag": "Mecanismo",
    "automata.heroDesc": "Una estructura de autómata armada a mano que simula movimiento mecánico, combinando precisión, creatividad e instrucciones técnicas.",
    "automata.desc1": "El proyecto consiste en el diseño y construcción de una estructura funcional de autómata mediante el ensamblaje manual de piezas. Este proceso incluye hacer cortes, doblar y unir piezas siguiendo instrucciones detalladas.",
    "automata.desc2": "El objetivo es crear un modelo mecánico que simule movimiento, combinando principios mecánicos básicos con precisión y creatividad. Este proyecto tiene un enfoque educativo, fomentando habilidades como la paciencia, el trabajo manual y la interpretación de planos e instrucciones técnicas.",
    "photoretouch.tag": "Retoque Fotográfico",
    "photoretouch.heroDesc": "Una pieza de pintura digital y retoque fotográfico, refinada mediante ajustes de color, capas y técnicas de pincel.",
    "photoretouch.desc1": "Se realizaron varias modificaciones a esta imagen, incluyendo ajustes de matiz y saturación para realzar los colores.",
    "photoretouch.desc2": "Además, se usaron técnicas avanzadas a través de capas y pinceles, logrando un acabado final cuidadosamente elaborado.",
    "photomontage.tag": "Foto",
    "photomontage.heroDesc": "Una composición de fotomontaje que combina varias imágenes con filtros y sombras para lograr un resultado final armonioso.",
    "photomontage.desc1": "Esta composición gráfica se construyó a partir de un fotomontaje que combina múltiples imágenes.",
    "photomontage.desc2": "Se aplicaron filtros y sombras estratégicas para lograr una integración armoniosa entre las diferentes fotografías, culminando en un acabado final.",
    "ecofarm.tag": "Foto",
    "ecofarm.heroDesc": "Una tarjeta promocional para una finca de ecoturismo, creada mediante fotomontaje combinando varias imágenes escénicas.",
    "ecofarm.desc1": "El diseño de esta tarjeta promocional para la finca de ecoturismo se creó mediante un fotomontaje que incorpora varias imágenes relevantes.",
    "ecofarm.desc2": "Se usaron filtros y sombras para integrar de forma cohesiva las diferentes escenas, resaltando la belleza natural y las experiencias únicas que ofrece la finca.",
    "coffeemag.tagStart": "Coffee",
    "coffeemag.tagEnd": "Design",
    "coffeemag.heroDesc": "Una revista editorial que celebra las mejores cafeterías de Chapinero, sus sabores, historias y ambiente acogedor.",
    "coffeemag.desc1": "Un proyecto editorial que celebra el amor por el café y los espacios que lo rodean. Esta revista es un recorrido por las cafeterías más queridas de Chapinero, resaltando sus sabores, historias y rincones acogedores.",
    "coffeemag.desc2": "Con un diseño limpio y visualmente atractivo, busca transmitir la esencia de cada lugar, como Levels Roasted Coffee, donde cada taza cuenta una historia.",
  },
};
